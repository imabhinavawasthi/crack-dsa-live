      ...
      <div className="gpt3__navbar-links">
        <div className="gpt3__navbar-links_logo">
          ...
          <NavLink to="/"><h1 className="logocss">
            <strong>
              crack<span className="logored">DSA</span>
            </strong>
          </h1></NavLink>
        </div>
        <div className="gpt3__navbar-links_container">
          ...
          <p>
            <NavLink className="nav-link-css" to="/courses">Courses</NavLink>
          </p>
          <p>
            <NavLink className="nav-link-css" to="/roadmaps">Roadmaps</NavLink>
          </p>
          <p>
